...
<head>
    <title>Bem-vindo à Metal School.</title>
                ...
                <div class="pcoded-wrapper">
                    <nav class="pcoded-navbar">
                        ...
                        <div class="pcoded-inner-navbar main-menu">
                            ...
                            <?php } else { ?>
                                <div class="pcoded-navigatio-lavel" data-i18n="nav.category.forms" menu-title-theme="theme1">Painel de Administração</div>
                                <ul class="pcoded-item pcoded-left-item">
                                    <li class="">
                                        <a href="index.php">
                                            <span class="pcoded-micon"><i class="ti-home"></i><b>D</b></span>
                                    ...
                                    <li class="">
                                        <a href="index.php?p=gerenciar_curso">
                                            <span class="pcoded-micon"><i class="ti-bag"></i><b>D</b></span>
                                    ...
                                    <li class="">
                                        <a href="index.php?p=gerenciar_usuario">
