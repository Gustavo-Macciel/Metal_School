...
if (isset($_POST['enviar'])) {
    ...
    if (count($erro) == 0) {
        ...
        die("<script>location.href=\"index.php?p=gerenciar_usuario\";</script>");
    }
}
                ...
                <div class="card-block">
                    <form action="" method="POST">
                        <div class="row">
                            ...
                            <div class="col-lg-12">
                                <a href="index.php?p=gerenciar_usuario" class="btn btn-primary btn-round"><i class="ti-arrow-left"></i> Voltar</a>
