    ...
    if (count($erro) == 0) {
        ...
        if ($deu_certo !== false) {
            ...
            if (!$inserido)
                ...
                die("<script>location.href=\"index.php?p=gerenciar_curso\";</script>");
            }
        } else
                ...
                <div class="card-block">
                    <form action="" method="POST" enctype="multipart/form-data">
                        <div class="row">
                            ...
                            <div class="col-lg-12">
                                <a href="index.php?p=gerenciar_curso" class="btn btn-primary btn-round"><i class="ti-arrow-left"></i> Voltar</a>
